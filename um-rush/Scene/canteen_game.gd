...
var enemy_scene = preload("res://Scene/enemy_l2.tscn")
...
var spawn_distance = 1400.0
var last_food_x = 0.0
var food_spawn_distance = 1200.0
var last_enemy_x = 0.0
var enemy_spawn_distance = 3300.0
...
func spawn_food():
	...
	var spawn_x = get_safe_spawn_x(player.position.x + 900.0, lane_y, 400.0)
	add_child(food)
	food.position = Vector2(spawn_x, lane_y)
...
func _on_next_level_pressed():
	...
	var label = Label.new()
	label.text = "Next stop: Library (Tiptoe)!"
