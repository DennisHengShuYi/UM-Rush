...
var goal_scene = preload("res://Scene/goal3.tscn")
...
var cat_spawn_distance = 17000.0
var stress = 0.0
...
func _show_start_notice():
	...
	notice_label.text = "📚 TIPTOE IN THE LIBRARY! HOLD SHIFT TO BE QUIET! 📚"
	notice_label.add_theme_font_size_override("font_size", 36)
	notice_label.add_theme_color_override("font_color", Color(1.0, 1.0, 0.0))
	notice_label.add_theme_color_override("font_outline_color", Color(0.0, 0.0, 0.2, 1))
...
func handle_enemy_hit(_enemy):
	...
	if stress >= max_stress:
		game_over("The library rush got too loud!")
...
func win():
	...
	if stress < 30:
		...
		message_label.text = "🎉 Pretty quiet!\nScore: A"
	elif stress < 80:
		message_label.text = "😅 A bit noisy...\nScore: B"
	else:
		message_label.text = "😵 The librarian is furious!\nScore: C"
	message_label.text = finish_level_score("Stayed quiet enough to pass!")
...
func _on_next_level_pressed():
	...
	var label = Label.new()
	label.text = "Next stop: FSKTM Building!"
